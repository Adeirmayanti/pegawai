...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container">
        <img class="img-fluid mb-5 d-block mx-auto" src="img/irma.jpeg" width="300" heigh="300" alt="">
        <h1 class="text-uppercase mb-0">Ade Irmayanti</h1>
        <h1 class="text-uppercase mb-0">12154952</h1>
        <hr class="star-light">
      </div>
    </header>
